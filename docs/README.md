...
| BL-62 | [`docs/research/2026-05-21_bl-62_synthesis-optimized-architectures_v1.md`](research/2026-05-21_bl-62_synthesis-optimized-architectures_v1.md) | Synthesis research: два оптимизированных сценария архитектуры (budget vs target), TCO 12 мес., roadmap, risks, validation gates. |
