# 📦 Бэклог оптимизации RAG-пайплайна (P0–P2) — v1.4
...
- **Дата:** 2026-05-20
- **Версия:** v1.4
- **Предыдущая версия:** [`docs/backlog/2026-05-17_backlog_rag-optimization_v1.3.md`](2026-05-17_backlog_rag-optimization_v1.3.md).
- **Автор:** konard (AI issue solver, по [issue #178](https://github.com/G-Ivan-A/clarify-engine-ai/issues/178))
- **Статус:** Draft → Review
...
- **Связанные документы:**
  ...
  - [`docs/standards/naming-convention.md`](../standards/naming-convention.md) v1.1 — стандарт именования (тип `backlog`, версия `v1.4`).
...
| BL-46 | Backlog branch update to v1.4 | P1 | 🟡 In Progress | BL-34..BL-45 | Заархивировать завершённые задачи Sprint 3 и добавить BL-47 | Этот файл v1.4 создан, архив Sprint 3 добавлен, CHANGELOG обновлён |
| BL-47 | Research: ARM Installer, Cloud TZ Access & Documentation Update Flow | P1 | ⏳ Waiting | BL-43, BL-45 | Исследование упрощённой установки, облачного доступа к ТЗ и обновления КБ для не-технических пользователей (пилот) | Research note с вариантами installer/cloud/update-flow, рисками NFR-04/NFR-05 и рекомендацией PO |
...
## 9. ✅ Критерии приёмки (Definition of Done) — v1.4

- [ ] Файл `docs/backlog/2026-05-17_backlog_rag-optimization_v1.4.md` создан и соответствует [`naming-convention.md`](../standards/naming-convention.md) v1.1 (тип `backlog`, MINOR-версия `v1.4`).
