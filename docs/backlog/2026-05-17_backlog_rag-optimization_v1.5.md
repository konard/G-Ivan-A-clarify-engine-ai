...
| BL-48 | ARM Installer L1 — `clarify-setup.cmd` First-Run wizard | P1 | ✅ Closed | BL-50, BL-51, BL-52 | Упростить первую установку на АРМ Windows 10/11 без ручных venv/pip/.env/Ollama/smoke steps (issue [#201](https://github.com/G-Ivan-A/clarify-engine-ai/issues/201)) | Installer L1 PoC: `scripts/install/clarify-setup.py`, `scripts/install/clarify-setup.cmd`, structured `logs/install.jsonl`, `.env.txt` guard, `qwen2.5:7b` Ollama contract, runbook Quick-start и тесты `tests/test_install_first_run.py` ([PR #202](https://github.com/G-Ivan-A/clarify-engine-ai/pull/202)) |
...
| BL-51 | Auto-detect Ollama installation path | P1 | ✅ Closed | BL-50 | На АРМ Windows установка Ollama по умолчанию в `%LOCALAPPDATA%\Programs\Ollama`, текущий код ожидает PATH (issue [#182](https://github.com/G-Ivan-A/clarify-engine-ai/issues/182), §2) | `_resolve_ollama_executable()` + `_log_ollama_executable_once()` в [`src/llm/client.py`](../../src/llm/client.py); тесты [`tests/test_ollama_resolution.py`](../../tests/test_ollama_resolution.py); runbook §1.4a с `setx PATH` и §6 обновлены (issue [#195](https://github.com/G-Ivan-A/clarify-engine-ai/issues/195), [PR #200](https://github.com/G-Ivan-A/clarify-engine-ai/pull/200)) |
...
| BL-53 | Streamlit `.env` cache documentation | P2 | 🟡 In Progress | BL-50 | После правки `.env` нужен явный рестарт Streamlit; в runbook это не зафиксировано (issue [#182](https://github.com/G-Ivan-A/clarify-engine-ai/issues/182), §4) | Acceptance — в [`2026-05-20_backlog_arm-pilot-test-fixes_v1.md`](2026-05-20_backlog_arm-pilot-test-fixes_v1.md) §4.5; реализация (минимальный scope: runbook §2/§6 + user guide + smoke-тест) — [PR #205](https://github.com/G-Ivan-A/clarify-engine-ai/pull/205) (issue [#198](https://github.com/G-Ivan-A/clarify-engine-ai/issues/198)) |
...
| BL-61.1 | Business-friendly education blocks and readable HTML tables for BL-61 | P1 | ✅ Closed | BL-61, BL-67 | Сделать BL-61 RU-education отчёт бизнес-читаемым без консультации Tech Lead: добавить RU-пояснение к каждому решению в таблицах, конкретизировать `Когда применять` под Clarify Engine и убрать HTML-обрезание ячеек (issue [#224](https://github.com/G-Ivan-A/clarify-engine-ai/issues/224)) | Артефакт [`../research/2026-05-21_bl-61_market-research_ru-education_v2.md`](../research/2026-05-21_bl-61_market-research_ru-education_v2.md), HTML [`../research/html/2026-05-21_bl-61_market-research_ru-education_v2.html`](../research/html/2026-05-21_bl-61_market-research_ru-education_v2.html), regression-тест [`../../tests/test_bl61_business_readable_v2.py`](../../tests/test_bl61_business_readable_v2.py), реализация [PR #225](https://github.com/G-Ivan-A/clarify-engine-ai/pull/225) |
| BL-62 | Synthesis research: optimized architecture options for pilot & production | P0 | ✅ Closed | BL-60, BL-61, BL-58, BL-59 | Синтезировать выводы BL-60/BL-61 и комментарии PO/support в два сценария: бюджетный `<= 2100 руб/мес` и целевой GPU-enabled hybrid pilot (issue [#226](https://github.com/G-Ivan-A/clarify-engine-ai/issues/226)) | Артефакт [`docs/research/2026-05-21_bl-62_synthesis-optimized-architectures_v1.md`](docs/research/2026-05-21_bl-62_synthesis-optimized-architectures_v1.md), regression-тест [`../../tests/test_bl62_synthesis_docs.py`](../../tests/test_bl62_synthesis_docs.py), реализация [PR #227](https://github.com/G-Ivan-A/clarify-engine-ai/pull/227) |
| BL-68 | Видение команды «Прорыва» — стратегия развития Clarify Engine | P1 | ✅ Closed | BL-62 | Сохранить в папке исследований независимое видение команды «Прорыва»: data moat, hybrid inference, Core+Extensible Shell архитектура и roadmap (issue [#230](https://github.com/G-Ivan-A/clarify-engine-ai/issues/230)). Не вносить в документацию. | Артефакт [`../research/2026-05-21_bl-68_breakthrough-team-vision_v1.md`](../research/2026-05-21_bl-68_breakthrough-team-vision_v1.md), реализация [PR #231](https://github.com/G-Ivan-A/clarify-engine-ai/pull/231) |

> **Сквозная нумерация (V-10) сохранена.** Следующий свободный ID после v1.5 — **BL-69**.
