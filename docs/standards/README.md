...
- [`export-markup.md`](export-markup.md) — единая схема разметки результата ИИ-анализа ТЗ для форматов `.xlsx` / `.docx` / `.md` (issues [#146](https://github.com/G-Ivan-A/clarify-engine-ai/issues/146), [#79](https://github.com/G-Ivan-A/clarify-engine-ai/issues/79)).
